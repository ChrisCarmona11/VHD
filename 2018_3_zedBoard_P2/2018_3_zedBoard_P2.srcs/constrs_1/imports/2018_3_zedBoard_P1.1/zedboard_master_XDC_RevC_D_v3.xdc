...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {TOP_CLOCK}];  # "GCLK"
set_property IOSTANDARD LVCMOS33 [get_ports TOP_CLOCK];
create_clock -period 10 [get_ports TOP_CLOCK];
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {ENTER}];  # "BTNC"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports NUMBER[0]];  # "SW0"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[0]]
set_property PACKAGE_PIN G22 [get_ports NUMBER[1]];  # "SW1"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[1]]
set_property PACKAGE_PIN H22 [get_ports NUMBER[2]];  # "SW2"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[2]]
set_property PACKAGE_PIN F21 [get_ports NUMBER[3]];  # "SW3"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[3]]
set_property PACKAGE_PIN H19 [get_ports NUMBER[4]];  # "SW4"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[4]]
set_property PACKAGE_PIN H18 [get_ports NUMBER[5]];  # "SW5"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[5]]
set_property PACKAGE_PIN H17 [get_ports NUMBER[6]];  # "SW6"
set_property IOSTANDARD LVCMOS33 [get_ports NUMBER[6]]
set_property PACKAGE_PIN M15 [get_ports NUMBER[7]];  # "SW7"
