...
HD_PWD='C:/Users/chris/Master/VHD/2018_3_zedboard_P1.2/2018_3_zedboard_P1.2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Multiplication_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Multiplication_TOP.tcl -notrace
