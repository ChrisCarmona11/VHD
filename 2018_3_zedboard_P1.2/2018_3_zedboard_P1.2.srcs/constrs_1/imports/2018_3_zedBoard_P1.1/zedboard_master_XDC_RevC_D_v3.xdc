...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {Result[5]}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {Result[6]}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {Result[7]}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {Result[8]}];  # "LD3"
set_property PACKAGE_PIN V22 [get_ports {Result[9]}];  # "LD4"
set_property PACKAGE_PIN W22 [get_ports {Result[10]}];  # "LD5"
set_property PACKAGE_PIN U19 [get_ports {Result[11]}];  # "LD6"
set_property PACKAGE_PIN U14 [get_ports {Result[12]}];  # "LD7"
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {A[3]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {A[4]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {A[5]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {A[6]}];  # "SW3"
